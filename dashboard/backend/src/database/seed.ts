    ...
    const workspaces = [
      {
        ...
        name: 'Overview',
        icon: 'layout',
        description: 'Core homelab systems layout dashboard',
        display_order: 0,
        is_default: 1
      },
      {
        ...
        name: 'Infrastructure',
        icon: 'server',
        description: 'Discovered services status logs',
        display_order: 1,
        is_default: 0
      },
      {
        ...
        name: 'Monitoring',
        icon: 'activity',
        description: 'Hardware load visualizers',
        display_order: 2,
        is_default: 0
      },
      {
        ...
        name: 'AI Stack',
        icon: 'sparkles',
        description: 'Local models and GPU metrics',
        display_order: 3,
        is_default: 0
      },
      {
        ...
        name: 'Networking',
        icon: 'globe',
        description: 'Ingress tunnels and DNS rules',
        display_order: 4,
        is_default: 0
      },
      {
        ...
        name: 'Storage',
        icon: 'database',
        description: 'ZFS pools and directory volumes',
        display_order: 5,
        is_default: 0
      }
    ];
