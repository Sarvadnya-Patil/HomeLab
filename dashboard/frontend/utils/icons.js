...
export const icons = {
  ...
  topology: `<svg class="nav-icon-svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="10" y1="10" x2="8" y2="8"></line><line x1="13.5" y1="11" x2="16.5" y2="9.5"></line><line x1="10.5" y1="14" x2="9" y2="16.5"></line><line x1="13.5" y1="14" x2="15" y2="16.5"></line><circle cx="12" cy="12" r="2.5"></circle><circle cx="6" cy="6" r="3.5"></circle><circle cx="18.5" cy="8.5" r="2.5"></circle><circle cx="7.5" cy="18.5" r="2.5"></circle><circle cx="16.5" cy="18.5" r="2.5"></circle></svg>`,
  ...
  falcon: `<svg class="logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="h-logo-grad-f" x1="0%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stop-color="#c8371d"/><stop offset="50%" stop-color="#eab308"/><stop offset="100%" stop-color="#facc15"/></linearGradient></defs><rect width="100" height="100" rx="18" fill="#000000"/><path fill="url(#h-logo-grad-f)" d="M 23,11 H 46 V 42 H 54 V 11 H 77 V 89 H 54 V 58 H 46 V 89 H 23 Z"/></svg>`,
