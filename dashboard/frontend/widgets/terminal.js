...
export default {
  ...
  render(container) {
    ...
    container.innerHTML = `
      ...
      <div class="terminal-body" style="background-color: var(--bg-shell); border: 1px solid var(--border-slate); border-radius: 4px; padding: 0.85rem; font-family: var(--font-mono); font-size: 0.75rem; height: 180px; overflow-y: auto; line-height: 1.45;">
        <div class="terminal-content" id="w-term-output">
