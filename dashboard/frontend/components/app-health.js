...
export const AppHealth = {
  ...
  updateMetricsUI() {
    ...
    container.innerHTML = `
      <!-- Host Platform specs -->
      <div class="res-card" style="padding: 1.25rem; background: #0e0e11; border: 2px solid #ffffff; box-shadow: 4px 4px 0 #ffffff !important; border-radius: 0; display: flex; flex-direction: column; gap: 0.6rem; font-family: var(--font-mono);">
