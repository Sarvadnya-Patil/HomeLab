   ...
   render() {
     ...
     this.container.innerHTML = `
       ...
       <div id="desktop-stream-view" style="display: none; width: 100%; height: 100vh; background: #000; position: relative; overflow: hidden; justify-content: center; align-items: center;">
         <!-- Absolutely positioned against the relative parent above, not
              percentage-sized as a flex child. This matches the diagnostics
              HUD below, which is also absolute-positioned and reliably
              renders at its intended size in this same layout -- filling via
              inset:0 sidesteps percentage/flex-resolution sizing entirely
